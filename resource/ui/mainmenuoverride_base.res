...
///////////////////
	...
	"ConsoleButton"
	{
		...
		"brighttext"	"0"
		"default"		"1"
		"command"		"engine showconsole; clear; echo middle mann v23.0.8; echo last updated: 20/11/24" //mostly used for bug reporting, remind self to update this string after every release
		"labeltext"		"Console"
		"sound_depressed"	"UI/buttonclick.wav"
		"sound_released"	"UI/buttonclickrelease.wav"
		"proportionaltoparent"	"1"

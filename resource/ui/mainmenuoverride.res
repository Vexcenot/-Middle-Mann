...
///////////////////
	...
	"ConsoleButton"
	{
		...
		"brighttext"	"0"
		"default"		"1"
		"command"		"engine con_enable 1; toggleconsole; echo middle mann v22.0.1; echo updated: 23/06/24" //mostly used for bug reporting, remind self to update this string after every release
		"labeltext"		"Console"
		"sound_depressed"	"UI/buttonclick.wav"
		"sound_released"	"UI/buttonclickrelease.wav"
		"proportionaltoparent"	"1"

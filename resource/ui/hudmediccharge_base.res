"Resource/UI/HudMedicCharge.res"
{
	"Background"
	{
		...
		"xpos"			"c1"  // turbo pos fuckery to make it as nice when swapping from primary to medigun
		"ypos"			"c167" // turbo pos fuckery to make it as nice when swapping from primary to medigun
		"zpos"			"-9"
		"wide"			"310"
		"tall"			"150"
		"visible"		"1"
